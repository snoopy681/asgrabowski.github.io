...
let continueSessionButton = document.getElementById('continue-session-button');
...
function confirmCharacter() {
    if (characterSelected) {
        ...
        setCookie("cookieReady", "notReady", 365);
    }
}
        ...
        card.onclick = (function () {
            if (!isSelected(card.firstChild) && cardCount < handSize) {
                ...
                if (cardHand1.classList.contains("flipped")) {
                    ...
                    setCookie("cardHand1Src", cardHand1.src, 365);
                    ...
                    setCookie("cardHand2Src", cardHand2.src, 365);
                    ...
                    setCookie("cardHand3Src", cardHand3.src, 365);
                    ...
                    setCookie("cardHand4Src", cardHand4.src, 365);
                    ...
                    setCookie("cardHand5Src", cardHand5.src, 365);
                    ...
                    setCookie("cardHand6Src", cardHand6.src, 365);
                    ...
                    setCookie("cardHand7Src", cardHand7.src, 365);
                    ...
                    setCookie("cardHand8Src", cardHand8.src, 365);
                    ...
                    setCookie("cardHand9Src", cardHand9.src, 365);
                    ...
                    setCookie("cardHand10Src", cardHand10.src, 365);
                    ...
                    setCookie("cardHand11Src", cardHand11.src, 365);
                    ...
                    setCookie("cardHand12Src", cardHand12.src, 365);
                }
            } else {
                ...
                if (cardHand1.classList.contains(`${this.id}`)) {
                    ...
                    setCookie("cardHand1Src", null, 365);
...
confirmHandButton.onclick = () => {
    if (cardCount === handSize) {
        ...
        // save everything to the cookie initially snoopy
        
        
        // Everything is saved, indicate the cookie is ready to go
        setCookie("cookieReady", "ready", 365);
    }
}
...
function confirmCookie() {
    var cookieReady = getCookie("cookieReady");
/*
let brute = document.getElementById('brute');
let cragheart = document.getElementById('cragheart');
let mindthief = document.getElementById('mindthief');
...
let nightshroud = document.getElementById("nightshroud");
 */
    if(cookieReady === "ready"){
        confirmCharacter();
        if (brute.classList.contains("character-selected")) {
            brConfirmPerksButton.onclick();
        } 
        else if (cragheart.classList.contains("character-selected")) {
            chConfirmPerksButton.onclick();
        }
        else if (mindthief.classList.contains("character-selected")) {
            mtConfirmPerksButton.onclick();
        ...
        confirmHandButton.classList.remove("not-without-more-selected");
        if(handSize >= 1){
            cardHand1.src = getCookie("cardHand1Src");
        }
        if(handSize >= 2){
            cardHand2.src = getCookie("cardHand2Src");
        }
        if(handSize >= 3){
            cardHand3.src = getCookie("cardHand3Src");
        }
        if(handSize >= 4){
            cardHand4.src = getCookie("cardHand4Src");
        }
        if(handSize >= 5){
            cardHand5.src = getCookie("cardHand5Src");
        }
        if(handSize >= 6){
            cardHand6.src = getCookie("cardHand6Src");
        }
        if(handSize >= 7){
            cardHand7.src = getCookie("cardHand7Src");
        }
        if(handSize >= 8){
            cardHand8.src = getCookie("cardHand8Src");
        }
        if(handSize >= 9){
            cardHand9.src = getCookie("cardHand9Src");
        }
        if(handSize >= 10){
            cardHand10.src = getCookie("cardHand10Src");
        }
        if(handSize >= 11){
            cardHand11.src = getCookie("cardHand11Src");
        }
        if(handSize >= 12){
            cardHand12.src = getCookie("cardHand12Src");
        }
        confirmHandButton.onclick();
    }
    else{
        alert("Data not available to resume session.");
    }
};
